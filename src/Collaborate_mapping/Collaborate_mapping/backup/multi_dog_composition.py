...
from Collaborate_mapping.Collaborate_mapping.backup.Image_replacer import ImageReplacer
from Collaborate_mapping.Collaborate_mapping.backup.RobotDog import RobotDog
